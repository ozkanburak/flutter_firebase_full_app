...
import 'package:flutter_firebase_full_app/product/enums/platform_enum.dart';
import 'package:flutter_firebase_full_app/product/models/number_model.dart';
import 'package:flutter_firebase_full_app/product/utility/exception/version_manager.dart';
    ...
    final response = await FirebaseCollections.version.reference
        .withConverter<NumberModel>(
            fromFirestore: (snapshot, options) =>
               NumberModel().fromFirestore(snapshot),
